# ------------------------------------------------------
# 📚 Today class based on: Python Data Types - Easy Guide
# 🏫 Class: One
# 👨‍💻 Author: Muhammad Hammad Zubair
# 📅 Date: April 2025
# 📘 Description:
#     This program explains the most common data types in Python.
#     It is written in a simple way so that beginners can understand easily.
# ------------------------------------------------------
